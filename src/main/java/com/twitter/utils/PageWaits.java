...
public class PageWaits {
  ...
  public static final long DEFAULT_PAGE_LOADING_TIMEOUT = 50;
  public static final long DEFAULT_ELEMENT_APPEAR_TIMEOUT = 25;
  public static final long DEFAULT_WINDOW_APPEAR_TIMEOUT = 10;
